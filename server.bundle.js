...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiRouter = __webpack_require__(9);
	...
	*/
	...
	app.use(_express2.default.static('./web/node_modules/bootstrap/dist'));
...
/***/ function(module, exports) {
	...
	module.exports = [{
	    "id": 1,
	    "heading": "Please enter your age."

	}, {
	    "id": 2,
	    "heading": "Please enter your target investment."
	}, {
	    "id": 3,
	    "heading": "Please enter your monthly investment."
	}];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Portfolio = __webpack_require__(16);
	...
	var _Questions = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Charts = __webpack_require__(18);
	...
	var Portfolio = _react2.default.createClass({
	  ...
	  render: function render() {
	    var element = _react2.default.createElement(_Charts2.default, { container: 'chart', options: this.state.config });
	    return element;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(6),
	    Highcharts = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Questions = _react2.default.createClass({
	  ...
	  updateActiveQuestion: function updateActiveQuestion() {
	    var me = this;
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { id: 'message' },
	        'We would like to know your requirements better so that we can serve you the best.',
	        _react2.default.createElement(
	          'p',
	          null,
	          'Please proceed to questionare'
	        ),
	        _react2.default.createElement(
	          'button',
	          { id: 'btnStart', onClick: this.start },
	          'Start'
	        )
	      ),
	      _react2.default.createElement(
	        'form',
	        { id: 'questionPanel', action: 'javascript:void 0;', className: 'hide' },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { id: 'btnPrev', className: 'btn btn-primary', onClick: this.goPrev },
	            'Prev'
	          ),
	          _react2.default.createElement(
	            'button',
	            { id: 'btnNext', className: 'btn btn-primary', onClick: this.goNext },
	            'Next'
	          ),
	          _react2.default.createElement('input', { type: 'submit', id: 'btnSubmit', value: 'Submit', onClick: this.submitAnswer, className: 'btn btn-success' })
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
		...
		getQuestionTemplate: function getQuestionTemplate(question) {
			var template = "";
			switch (question.type) {
				case 'ONAO':
					//option none answer one
					template = _react2.default.createElement("input", { type: "text", className: "form-control", name: "answer", id: "answer", placeholder: "Your Answer", value: question.answer });
					break;
				case 'OMAO':
					//option many aanswer one
					template = _react2.default.createElement(
						...
						_react2.default.createElement(
							"li",
							null,
							question.options.map(function (v, index) {
								return _react2.default.createElement(
									"div",
									{ key: index, className: "form-check" },
									_react2.default.createElement(
										"label",
										{ className: "form-check-label" },
										_react2.default.createElement("input", { className: "form-check-input", type: "radio", name: "answer", id: "radio1", value: v.submitValue }),
										v.displayValue
									)
								);
							})
							...
							question.options.map(function (v, index) {
								return _react2.default.createElement(
									...
									_react2.default.createElement(
										"label",
										{ className: "form-check-label" },
										_react2.default.createElement("input", { className: "form-check-input", type: "radio", name: "answer", id: "checkbox1", value: v.submitValue }),
										v.displayValue
									)
								);
							})
				...
				default:
					template = _react2.default.createElement(
						"div",
						null,
						"\"No appropriate question definition is found for this question type\""
					);
			}
